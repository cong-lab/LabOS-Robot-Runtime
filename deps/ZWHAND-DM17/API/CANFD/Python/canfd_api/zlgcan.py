...
def canfd_start(zcanlib, device_handle, chn, arb_baud_rate, data_baud_rate):
    ...
    if arb_baud_rate == 1000000:
        zcanlib.ZCAN_SetValue(device_handle, "0/canfd_abit_brp", str(5))
        zcanlib.ZCAN_SetValue(device_handle, "0/canfd_abit_tseg1", str(7))
        zcanlib.ZCAN_SetValue(device_handle, "0/canfd_abit_tseg2", str(3))
    zcanlib.ZCAN_SetValue(device_handle, "0/canfd_dbit_baud_rate", data_baud_rate)  # 设置数据域波特率
    if data_baud_rate == 5000000:
        zcanlib.ZCAN_SetValue(device_handle, "0/canfd_dbit_brp", str(5))
        zcanlib.ZCAN_SetValue(device_handle, "0/canfd_dbit_tseg1", str(7))
        zcanlib.ZCAN_SetValue(device_handle, "0/canfd_dbit_tseg2", str(3))
